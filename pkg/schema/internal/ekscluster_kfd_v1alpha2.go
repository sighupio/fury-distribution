...
type EksclusterKfdV1Alpha2InternalKind string

var enumValues_EksclusterKfdV1Alpha2InternalKind = []interface{}{
	"EKSCluster",
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *EksclusterKfdV1Alpha2InternalKind) UnmarshalJSON(b []byte) error {
	var v string
	if err := json.Unmarshal(b, &v); err != nil {
		return err
	}
	var ok bool
	for _, expected := range enumValues_EksclusterKfdV1Alpha2InternalKind {
		if reflect.DeepEqual(v, expected) {
			ok = true
			break
		}
	...
	if !ok {
		return fmt.Errorf("invalid value (expected one of %#v): %#v", enumValues_EksclusterKfdV1Alpha2InternalKind, v)
	}
	*j = EksclusterKfdV1Alpha2InternalKind(v)
	return nil
}

const EksclusterKfdV1Alpha2InternalKindEKSCluster EksclusterKfdV1Alpha2InternalKind = "EKSCluster"

// A Fury Cluster deployed through AWS's Elastic Kubernetes Service
type EksclusterKfdV1Alpha2Internal struct {
	// ApiVersion corresponds to the JSON schema field "apiVersion".
	ApiVersion string `json:"apiVersion" yaml:"apiVersion"`

	// Kind corresponds to the JSON schema field "kind".
	Kind EksclusterKfdV1Alpha2InternalKind `json:"kind" yaml:"kind"`
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *EksclusterKfdV1Alpha2Internal) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["apiVersion"]; !ok || v == nil {
		return fmt.Errorf("field apiVersion in EksclusterKfdV1Alpha2Internal: required")
	}
	if v, ok := raw["kind"]; !ok || v == nil {
		return fmt.Errorf("field kind in EksclusterKfdV1Alpha2Internal: required")
	}
	if v, ok := raw["metadata"]; !ok || v == nil {
		return fmt.Errorf("field metadata in EksclusterKfdV1Alpha2Internal: required")
	}
	if v, ok := raw["spec"]; !ok || v == nil {
		return fmt.Errorf("field spec in EksclusterKfdV1Alpha2Internal: required")
	}
	type Plain EksclusterKfdV1Alpha2Internal
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = EksclusterKfdV1Alpha2Internal(plain)
	return nil
}
