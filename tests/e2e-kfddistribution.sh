...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-init-cluster.yaml --outdir "$PWD" --distro-location ./ --force all --disable-analytics
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-2-migrate-from-tempo-to-none.yaml --outdir "$PWD" --distro-location ./ --force all --skip-deps-download --disable-analytics
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-3-migrate-from-kyverno-to-none.yaml --outdir "$PWD" --distro-location ./ --force all --skip-deps-download --disable-analytics
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-4-migrate-from-velero-to-none.yaml --outdir "$PWD" --distro-location ./ --force all --skip-deps-download --disable-analytics
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-5-migrate-from-loki-to-none.yaml --outdir "$PWD" --distro-location ./ --force all --skip-deps-download --disable-analytics
bats -t tests/e2e-kfddistribution-5-migrate-from-loki-to-none.sh

echo "----------------------------------------------------------------------------"
echo "Executing furyctl with the mimir migration to none"
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-6-migrate-from-mimir-to-none.yaml --outdir "$PWD" --distro-location ./ --force all --skip-deps-download --disable-analytics
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-9-migrate-from-nginx-to-none.yaml --outdir "$PWD" --distro-location ./ --force all --skip-deps-download --disable-analytics
bats -t tests/e2e-kfddistribution-9-migrate-from-nginx-to-none.sh

echo "----------------------------------------------------------------------------"
echo "Executing furyctl testing migrations from none (SAFE)"
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-10-migrate-from-none-to-safe-values.yaml --outdir "$PWD" --distro-location ./ --skip-deps-download --disable-analytics

echo "----------------------------------------------------------------------------"
echo "Executing furyctl testing kyverno uninstall policies (SAFE)"
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-11-migrate-from-kyverno-default-policies-to-disabled.yaml --outdir "$PWD" --distro-location ./ --skip-deps-download --disable-analytics
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-12-migrate-from-alertmanagerconfigs-to-disabled.yaml --outdir "$PWD" --distro-location ./ --skip-deps-download --disable-analytics
