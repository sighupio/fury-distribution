...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-6-migrate-from-prometheus-to-none.yaml --outdir "$PWD" -H --distro-location ./ --force --skip-deps-download
