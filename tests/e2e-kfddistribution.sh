...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-init-cluster.yaml --outdir "$PWD" -H --distro-location ./ --force all
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-init-with-values-from-nil.yaml --outdir "$PWD" -H --distro-location ./ --skip-deps-download --force all
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-cleanup-all.yaml --outdir "$PWD" -H --distro-location ./ --skip-deps-download --force all
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-2-migrate-from-tempo-to-none.yaml --outdir "$PWD" -H --distro-location ./ --force all --skip-deps-download
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-3-migrate-from-kyverno-to-none.yaml --outdir "$PWD" -H --distro-location ./ --force all --skip-deps-download
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-4-migrate-from-velero-to-none.yaml --outdir "$PWD" -H --distro-location ./ --force all --skip-deps-download
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-5-migrate-from-loki-to-none.yaml --outdir "$PWD" -H --distro-location ./ --force all --skip-deps-download
bats -t tests/e2e-kfddistribution-5-migrate-from-loki-to-none.sh

echo "----------------------------------------------------------------------------"
echo "Executing furyctl with the mimir migration to none"
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-6-migrate-from-mimir-to-none.yaml --outdir "$PWD" -H --distro-location ./ --force all --skip-deps-download
...
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-7-migrate-from-basicAuth-to-sso.yaml --outdir "$PWD" -H --distro-location ./ --force all --skip-deps-download
bats -t tests/e2e-kfddistribution-7-migrate-from-basicAuth-to-sso.sh

echo "----------------------------------------------------------------------------"
echo "Executing furyctl with the auth basic to sso migration"
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-8-migrate-from-sso-to-none.yaml --outdir "$PWD" -H --distro-location ./ --force all --skip-deps-download
bats -t tests/e2e-kfddistribution-8-migrate-from-sso-to-none.sh

echo "----------------------------------------------------------------------------"
echo "Executing furyctl with the nginx migration to none"
/tmp/furyctl create cluster --config tests/e2e/kfddistribution/furyctl-9-migrate-from-nginx-to-none.yaml --outdir "$PWD" -H --distro-location ./ --force all --skip-deps-download
