...
- [ingress](https://github.com/sighupio/fury-kubernetes-ingress) 📦 core module: v1.13.1 -> [**v1.14.0**](https://github.com/sighupio/fury-kubernetes-ingress/releases/tag/v1.14.0)
