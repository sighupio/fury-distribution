# SIGHUP Kubernetes Distribution Release v1.26.2
...
With the `OnPremise` provider, you can effortlessly install preconfigured Kubernetes clusters using the SIGHUP Kubernetes Distribution (SKD) right in your on-premises VMs.
