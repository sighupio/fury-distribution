...
This release updates all the modules to the latest version and maintain compatibility with Kubernetes 1.23.

## New Features since `v1.23.4`
...
- [monitoring](https://github.com/sighupio/fury-kubernetes-monitoring) 📦 core module: v2.0.1
  - No updates
