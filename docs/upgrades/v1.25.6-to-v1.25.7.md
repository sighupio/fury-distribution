# Kubernetes Fury Distribution v1.25.6 to 1.25.7 Upgrade Guide

This guide describes the steps to follow to upgrade the Kubernetes Fury Distribution (KFD) from v1.25.6 to 1.25.7.
