...
This document explains the full schema for the `kind: KFDDistribution` for the `furyctl.yaml` file used by `furyctl`. This configuration file will be used to deploy the SIGHUP Kubernetes Distribution modules on top of an existing Kubernetes cluster.
